...
export class ClassFactory {
    public static createGrammar: (tool: ITool, tree: GrammarSpecContext) => IGrammar;
    public static createLexerGrammar: (tool: ITool, tree: GrammarSpecContext) => ILexerGrammar;
