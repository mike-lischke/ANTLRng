...
export class ATNBuilder extends TreeParser {
    ...
    public constructor(input: TreeNodeStream, stateOrFactory?: IRecognizerSharedState | IATNFactory) {
        ...
        if ("_fsp" in stateOrFactory) { // RecognizerSharedState
                ...
                case GrammarTreeVisitor.STRING_LITERAL: {
                    {
                        ...
                        if ((LA18_1 === Constants.DOWN)) {
                            ...
                            if ((LA18_1 === Constants.UP || LA18_1 === ATNBuilder.LEXER_CHAR_SET
                ...
                case GrammarTreeVisitor.TOKEN_REF: {
                    {
                        ...
                        if ((LA18_2 === Constants.DOWN)) {
                            ...
                            if ((LA18_2 === Constants.UP || LA18_2 === ATNBuilder.LEXER_CHAR_SET
