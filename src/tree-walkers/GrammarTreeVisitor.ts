...
export class GrammarTreeVisitor extends TreeParser {
    ...
    public visit(t: GrammarAST, ruleIndex: number): void {
        ...
        try {
            ...
            if (e instanceof Error) {
                ...
                ErrorManager.get().toolError(ErrorType.INTERNAL_ERROR, error);
            } else {
                throw e;
            }
        }
                ...
                try {
                    ...
                    switch (alt55) {
                        case 1: {
                            ...
                            {
                                ID45 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        ...
                        case 3: {
                            // org/antlr/v4/parse/GrammarTreeVisitor.g:1017:9: ^( ASSIGN ID v= STRING_LITERAL )
                            {
                                this.match(this.input, ANTLRv4Lexer.ASSIGN, null);
                                this.match(this.input, Constants.DOWN, null);
                                ID46 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        ...
                        case 4: {
                            // org/antlr/v4/parse/GrammarTreeVisitor.g:1018:9: ^( ASSIGN ID v= ACTION )
                            {
                                this.match(this.input, ANTLRv4Lexer.ASSIGN, null);
                                this.match(this.input, Constants.DOWN, null);
                                ID47 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        ...
                        case 5: {
                            // org/antlr/v4/parse/GrammarTreeVisitor.g:1019:9: ^( ASSIGN ID v= INT )
                            {
                                this.match(this.input, ANTLRv4Lexer.ASSIGN, null);
                                this.match(this.input, Constants.DOWN, null);
                                ID48 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
        ...
        switch (args.length) {
            case 0: {
                ...
                try {
                    ...
                    if ((LA39_0 === ANTLRv4Lexer.LEXER_ACTION_CALL)) {
                        alt39 = 1;
                    } else {
                        if ((LA39_0 === ANTLRv4Lexer.ID)) {
                            alt39 = 2;
                        } else {
                            const nvae =
                    ...
                    switch (alt39) {
                        case 1: {
                            // org/antlr/v4/parse/GrammarTreeVisitor.g:803:4: ^( LEXER_ACTION_CALL ID lexerCommandExpr )
                            {
                                ...
                                this.match(this.input, Constants.DOWN, null);
                                ID25 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        ...
                        case 2: {
                            ...
                            {
                                ID27 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
    ...
    public grammarSpec(): GrammarTreeVisitor.grammarSpec_return {
        ...
        try {
            ...
            {
                GRAMMAR2 = this.match(this.input, ANTLRv4Lexer.GRAMMAR, null) as GrammarAST | null;
                this.match(this.input, Constants.DOWN, null);
                ID1 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST | null;
    ...
    public prequelConstructs(): GrammarTreeVisitor.prequelConstructs_return {
        ...
        try {
            ...
            if ((LA3_0 === ANTLRv4Lexer.AT || LA3_0 === ANTLRv4Lexer.CHANNELS || LA3_0 === ANTLRv4Lexer.IMPORT || LA3_0 === ANTLRv4Lexer.OPTIONS || LA3_0 === ANTLRv4Lexer.TOKENS_SPEC)) {
                alt3 = 1;
            } else {
                if ((LA3_0 === ANTLRv4Lexer.RULES)) {
                    alt3 = 2;
                } else {
                    const nvae =
                ...
                case 1: {
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:364:4: ( prequelConstruct )+
                    {
                        ...
                        while (true) {
                            ...
                            if ((LA2_0 === ANTLRv4Lexer.AT || LA2_0 === ANTLRv4Lexer.CHANNELS || LA2_0 === ANTLRv4Lexer.IMPORT || LA2_0 === ANTLRv4Lexer.OPTIONS || LA2_0 === ANTLRv4Lexer.TOKENS_SPEC)) {
                                alt2 = 1;
                            }
    ...
    public option(): GrammarTreeVisitor.option_return {
        ...
        try {
            ...
            {
                //const a = this.match(this.input!, ANTLRv4Lexer.ASSIGN, null) as GrammarAST | null;
                this.match(this.input, Constants.DOWN, null);
                ID4 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST | null;
                v = this.optionValue();
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:
            {
                if (this.input.LA(1) === ANTLRv4Lexer.ID || this.input.LA(1) === ANTLRv4Lexer.INT
                    || this.input.LA(1) === ANTLRv4Lexer.STRING_LITERAL) {
                    this.input.consume();
    ...
    public delegateGrammars(): GrammarTreeVisitor.delegateGrammars_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.IMPORT, null);
                this.match(this.input, Constants.DOWN, null);
                ...
                while (true) {
                    ...
                    if ((LA6_0 === ANTLRv4Lexer.ASSIGN || LA6_0 === ANTLRv4Lexer.ID)) {
                        alt6 = 1;
                    }
    ...
    public delegateGrammar(): GrammarTreeVisitor.delegateGrammar_return {
        ...
        try {
            ...
            if ((LA7_0 === ANTLRv4Lexer.ASSIGN)) {
                alt7 = 1;
            } else {
                if ((LA7_0 === ANTLRv4Lexer.ID)) {
                    alt7 = 2;
                } else {
                    const nvae =
            ...
            switch (alt7) {
                case 1: {
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:439:9: ^( ASSIGN label= ID id= ID )
                    {
                        this.match(this.input, ANTLRv4Lexer.ASSIGN, null);
                        this.match(this.input, Constants.DOWN, null);
                        label = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        id = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        this.match(this.input, Constants.UP, null);
    ...
    public tokensSpec(): GrammarTreeVisitor.tokensSpec_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.TOKENS_SPEC, null);
                this.match(this.input, Constants.DOWN, null);
    ...
    public channelsSpec(): GrammarTreeVisitor.channelsSpec_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.CHANNELS, null);
                this.match(this.input, Constants.DOWN, null);
    ...
    public channelSpec(): GrammarTreeVisitor.channelSpec_return {
        ...
        try {
            ...
            {
                ID6 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:490:4: ^( AT (sc= ID )? name= ID ACTION )
            {
                ...
                switch (alt10) {
                    case 1: {
                        // org/antlr/v4/parse/GrammarTreeVisitor.g:490:11: sc= ID
                        {
                            sc = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                        }
                        break;
                    }
                ...
                name = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
                ACTION7 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                this.match(this.input, Constants.UP, null);
    ...
    public rules(): GrammarTreeVisitor.rules_return {
        ...
        try {
            ...
            {
                RULES8 = this.match(this.input, ANTLRv4Lexer.RULES, null) as GrammarAST;
                ...
                if (this.input.LA(1) === Constants.DOWN) {
                    ...
                    while (true) {
                        ...
                        if ((LA11_0 === ANTLRv4Lexer.RULE)) {
                            const LA11_2 = this.input.LA(2);
                            if ((LA11_2 === Constants.DOWN)) {
                                const LA11_3 = this.input.LA(3);
                                if ((LA11_3 === ANTLRv4Lexer.RULE_REF)) {
                                    alt11 = 1;
                                } else {
                                    if ((LA11_3 === ANTLRv4Lexer.TOKEN_REF)) {
                                        alt11 = 2;
                                    }
                                }
    ...
    public mode(): GrammarTreeVisitor.mode_return {
        ...
        try {
            ...
            {
                MODE10 = this.match(this.input, ANTLRv4Lexer.MODE, null) as GrammarAST | null;
                this.match(this.input, Constants.DOWN, null);
                ID9 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST | null;
    ...
    public lexerRule(): GrammarTreeVisitor.lexerRule_return {
        ...
        try {
            ...
            {
                RULE12 = this.match(this.input, ANTLRv4Lexer.RULE, null) as GrammarAST | null;
                this.match(this.input, Constants.DOWN, null);
                TOKEN_REF11 = this.match(this.input, ANTLRv4Lexer.TOKEN_REF, null) as GrammarAST | null;
                ...
                if ((LA13_0 === ANTLRv4Lexer.RULEMODIFIERS)) {
                    alt13 = 1;
                }
                switch (alt13) {
                    case 1: {
                        ...
                        {
                            this.match(this.input, ANTLRv4Lexer.RULEMODIFIERS, null);
                            this.match(this.input, Constants.DOWN, null);
                            m = this.match(this.input, ANTLRv4Lexer.FRAGMENT, null) as GrammarAST;
                            mods.push(m);
                            this.match(this.input, Constants.UP, null);
                ...
                while (true) {
                    ...
                    if ((LA14_0 === ANTLRv4Lexer.OPTIONS)) {
                        alt14 = 1;
                    }
    ...
    public ruleSpec(): GrammarTreeVisitor.rule_return {
        ...
        try {
            ...
            {
                RULE15 = this.match(this.input, ANTLRv4Lexer.RULE, null) as GrammarAST | null;
                this.match(this.input, Constants.DOWN, null);
                RULE_REF14 = this.match(this.input, ANTLRv4Lexer.RULE_REF, null) as GrammarAST | null;
                ...
                if ((LA16_0 === ANTLRv4Lexer.RULEMODIFIERS)) {
                    alt16 = 1;
                }
                switch (alt16) {
                    case 1: {
                        // org/antlr/v4/parse/GrammarTreeVisitor.g:546:5: ^( RULEMODIFIERS (m= ruleModifier )+ )
                        {
                            ...
                            while (true) {
                                ...
                                if ((LA15_0 === ANTLRv4Lexer.FRAGMENT || (LA15_0 >= ANTLRv4Lexer.PRIVATE && LA15_0 <= ANTLRv4Lexer.PUBLIC))) {
                                    alt15 = 1;
                                }
                ...
                if ((LA17_0 === ANTLRv4Lexer.ARG_ACTION)) {
                    alt17 = 1;
                }
                switch (alt17) {
                    case 1: {
                        // org/antlr/v4/parse/GrammarTreeVisitor.g:547:4: ARG_ACTION
                        {
                            ARG_ACTION16 = this.match(this.input, ANTLRv4Lexer.ARG_ACTION, null) as GrammarAST;
                        }
                        break;
                    }
                ...
                if ((LA18_0 === ANTLRv4Lexer.RETURNS)) {
                    alt18 = 1;
                }
                switch (alt18) {
                    case 1: {
                ...
                while (true) {
                    ...
                    if ((LA21_0 === ANTLRv4Lexer.OPTIONS)) {
                        alt21 = 1;
                    } else {
                        if ((LA21_0 === ANTLRv4Lexer.AT)) {
                            alt21 = 2;
                        }
                    }
    ...
    public exceptionGroup(): GrammarTreeVisitor.exceptionGroup_return {
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:571:7: ( exceptionHandler )* ( finallyClause )?
            {
                ...
                if ((LA23_0 === ANTLRv4Lexer.FINALLY)) {
                    alt23 = 1;
                }
                switch (alt23) {
                    case 1: {
    ...
    public exceptionHandler(): GrammarTreeVisitor.exceptionHandler_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.CATCH, null);
                this.match(this.input, Constants.DOWN, null);
                ARG_ACTION18 = this.match(this.input, ANTLRv4Lexer.ARG_ACTION, null) as GrammarAST;
                ACTION19 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                this.match(this.input, Constants.UP, null);
    ...
    public finallyClause(): GrammarTreeVisitor.finallyClause_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.FINALLY, null);
                this.match(this.input, Constants.DOWN, null);
                ACTION20 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                this.match(this.input, Constants.UP, null);
    ...
    public locals(): GrammarTreeVisitor.locals_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.LOCALS, null);
                this.match(this.input, Constants.DOWN, null);
    ...
    public ruleReturns(): GrammarTreeVisitor.ruleReturns_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.RETURNS, null);
                this.match(this.input, Constants.DOWN, null);
                this.match(this.input, ANTLRv4Lexer.ARG_ACTION, null);
                this.match(this.input, Constants.UP, null);
    ...
    public throwsSpec(): GrammarTreeVisitor.throwsSpec_return {
        ...
        try {
            ...
            {
                this.match(this.input, ANTLRv4Lexer.THROWS, null);
                this.match(this.input, Constants.DOWN, null);
    ...
    public ruleModifier(): GrammarTreeVisitor.ruleModifier_return {
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:
            {
                if (this.input.LA(1) === ANTLRv4Lexer.FRAGMENT || (this.input.LA(1) >= ANTLRv4Lexer.PRIVATE && this.input.LA(1) <= ANTLRv4Lexer.PUBLIC)) {
                    this.input.consume();
                    this.state.errorRecovery = false;
                } else {
                    const mse = new MismatchedSetException(null, this.input);
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:654:7: ^( BLOCK ( lexerOuterAlternative )+ )
            {
                ...
                while (true) {
                    ...
                    if ((LA25_0 === ANTLRv4Lexer.ALT || LA25_0 === ANTLRv4Lexer.LEXER_ALT_ACTION)) {
                        alt25 = 1;
                    }
    ...
    public lexerAlternative(): GrammarTreeVisitor.lexerAlternative_return {
        ...
        try {
            ...
            if ((LA28_0 === ANTLRv4Lexer.LEXER_ALT_ACTION)) {
                alt28 = 1;
            } else {
                if ((LA28_0 === ANTLRv4Lexer.ALT)) {
                    alt28 = 2;
                } else {
                    const nvae =
                ...
                case 1: {
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:713:4: ^( LEXER_ALT_ACTION lexerElements ( lexerCommand )+ )
                    {
                        ...
                        while (true) {
                            ...
                            if ((LA27_0 === ANTLRv4Lexer.ID || LA27_0 === ANTLRv4Lexer.LEXER_ACTION_CALL)) {
                                alt27 = 1;
                            }
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:724:7: ^( ALT ( lexerElement )+ )
            {
                ...
                while (true) {
                    ...
                    if ((LA29_0 === ANTLRv4Lexer.ACTION || LA29_0 === ANTLRv4Lexer.LEXER_CHAR_SET || LA29_0 === ANTLRv4Lexer.NOT || LA29_0 === ANTLRv4Lexer.RANGE || LA29_0 === ANTLRv4Lexer.RULE_REF || LA29_0 === ANTLRv4Lexer.SEMPRED || LA29_0 === ANTLRv4Lexer.STRING_LITERAL || LA29_0 === ANTLRv4Lexer.TOKEN_REF || (LA29_0 >= ANTLRv4Lexer.BLOCK && LA29_0 <= ANTLRv4Lexer.CLOSURE) || LA29_0 === ANTLRv4Lexer.EPSILON || (LA29_0 >= ANTLRv4Lexer.OPTIONAL && LA29_0 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA29_0 >= ANTLRv4Lexer.SET && LA29_0 <= ANTLRv4Lexer.WILDCARD))) {
                        alt29 = 1;
                    }
        ...
        try {
                ...
                case ANTLRv4Lexer.ACTION: {
                    {
                        ...
                        if ((LA30_3 === Constants.DOWN)) {
                            ...
                            if (((LA30_3 >= Constants.UP && LA30_3 <= ANTLRv4Lexer.ACTION) || LA30_3 === ANTLRv4Lexer.LEXER_CHAR_SET || LA30_3 === ANTLRv4Lexer.NOT || LA30_3 === ANTLRv4Lexer.RANGE || LA30_3 === ANTLRv4Lexer.RULE_REF || LA30_3 === ANTLRv4Lexer.SEMPRED || LA30_3 === ANTLRv4Lexer.STRING_LITERAL || LA30_3 === ANTLRv4Lexer.TOKEN_REF || (LA30_3 >= ANTLRv4Lexer.BLOCK && LA30_3 <= ANTLRv4Lexer.CLOSURE) || LA30_3 === ANTLRv4Lexer.EPSILON || (LA30_3 >= ANTLRv4Lexer.OPTIONAL && LA30_3 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA30_3 >= ANTLRv4Lexer.SET && LA30_3 <= ANTLRv4Lexer.WILDCARD))) {
                                alt30 = 3;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
                ...
                case ANTLRv4Lexer.SEMPRED: {
                    {
                        ...
                        if ((LA30_4 === Constants.DOWN)) {
                            ...
                            if (((LA30_4 >= Constants.UP && LA30_4 <= ANTLRv4Lexer.ACTION) || LA30_4 === ANTLRv4Lexer.LEXER_CHAR_SET || LA30_4 === ANTLRv4Lexer.NOT || LA30_4 === ANTLRv4Lexer.RANGE || LA30_4 === ANTLRv4Lexer.RULE_REF || LA30_4 === ANTLRv4Lexer.SEMPRED || LA30_4 === ANTLRv4Lexer.STRING_LITERAL || LA30_4 === ANTLRv4Lexer.TOKEN_REF || (LA30_4 >= ANTLRv4Lexer.BLOCK && LA30_4 <= ANTLRv4Lexer.CLOSURE) || LA30_4 === ANTLRv4Lexer.EPSILON || (LA30_4 >= ANTLRv4Lexer.OPTIONAL && LA30_4 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA30_4 >= ANTLRv4Lexer.SET && LA30_4 <= ANTLRv4Lexer.WILDCARD))) {
                                alt30 = 4;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
            ...
            switch (alt30) {
                ...
                case 3: {
                    ...
                    {
                        ACTION21 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                ...
                case 4: {
                    ...
                    {
                        SEMPRED22 = this.match(this.input, ANTLRv4Lexer.SEMPRED, null) as GrammarAST;
                ...
                case 5: {
                    ...
                    {
                        ACTION23 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 6: {
                    ...
                    {
                        SEMPRED24 = this.match(this.input, ANTLRv4Lexer.SEMPRED, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:750:5: ^( BLOCK ( optionsSpec )? ( lexerAlternative )+ )
            {
                ...
                while (true) {
                    ...
                    if ((LA32_0 === ANTLRv4Lexer.ALT || LA32_0 === ANTLRv4Lexer.LEXER_ALT_ACTION)) {
                        alt32 = 1;
                    }
                ...
                case ANTLRv4Lexer.WILDCARD: {
                    {
                        ...
                        if ((LA33_4 === Constants.DOWN)) {
                            ...
                            if (((LA33_4 >= Constants.UP && LA33_4 <= ANTLRv4Lexer.ACTION) || LA33_4 === ANTLRv4Lexer.LEXER_CHAR_SET || LA33_4 === ANTLRv4Lexer.NOT || LA33_4 === ANTLRv4Lexer.RANGE || LA33_4 === ANTLRv4Lexer.RULE_REF || LA33_4 === ANTLRv4Lexer.SEMPRED || LA33_4 === ANTLRv4Lexer.STRING_LITERAL || LA33_4 === ANTLRv4Lexer.TOKEN_REF || (LA33_4 >= ANTLRv4Lexer.BLOCK && LA33_4 <= ANTLRv4Lexer.CLOSURE) || LA33_4 === ANTLRv4Lexer.EPSILON || (LA33_4 >= ANTLRv4Lexer.OPTIONAL && LA33_4 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA33_4 >= ANTLRv4Lexer.SET && LA33_4 <= ANTLRv4Lexer.WILDCARD))) {
                                alt33 = 5;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
    ...
    public actionElement(): GrammarTreeVisitor.actionElement_return {
        ...
        try {
            ...
            if ((LA34_0 === ANTLRv4Lexer.ACTION)) {
                const LA34_1 = this.input.LA(2);
                if ((LA34_1 === Constants.DOWN)) {
                    alt34 = 2;
                } else {
                    if ((LA34_1 === ANTLRv4Lexer.EOF)) {
                        alt34 = 1;
                    } else {
                        const nvaeMark = this.input.mark();
                        try {
                ...
                if ((LA34_0 === ANTLRv4Lexer.SEMPRED)) {
                    const LA34_2 = this.input.LA(2);
                    if ((LA34_2 === Constants.DOWN)) {
                        alt34 = 4;
                    } else {
                        if ((LA34_2 === ANTLRv4Lexer.EOF)) {
                            alt34 = 3;
                        } else {
                            const nvaeMark = this.input.mark();
                            try {
            ...
            switch (alt34) {
                ...
                case 3: {
                    ...
                    {
                        this.match(this.input, ANTLRv4Lexer.SEMPRED, null);
                    }
                    break;
                }
    ...
    public alternative(): GrammarTreeVisitor.alternative_return {
        ...
        try {
            ...
            let alt38: number = 1;
            if (retval.start?.getChild(0)?.getType() === ANTLRv4Lexer.EPSILON) { // Empty alternative.
                alt38 = 2;
            }
            ...
            switch (alt38) {
                case 1: {
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:792:4: ^( ALT ( elementOptions )? ( element )+ )
                    {
                        ...
                        if ((LA35_0 === ANTLRv4Lexer.ELEMENT_OPTIONS)) {
                            alt35 = 1;
                        }
                        switch (alt35) {
                            case 1: {
                        ...
                        while (true) {
                            ...
                            if ((LA36_0 === ANTLRv4Lexer.ACTION || LA36_0 === ANTLRv4Lexer.ASSIGN || LA36_0 === ANTLRv4Lexer.DOT || LA36_0 === ANTLRv4Lexer.NOT || LA36_0 === ANTLRv4Lexer.PLUS_ASSIGN || LA36_0 === ANTLRv4Lexer.RANGE || LA36_0 === ANTLRv4Lexer.RULE_REF || LA36_0 === ANTLRv4Lexer.SEMPRED || LA36_0 === ANTLRv4Lexer.STRING_LITERAL || LA36_0 === ANTLRv4Lexer.TOKEN_REF || (LA36_0 >= ANTLRv4Lexer.BLOCK && LA36_0 <= ANTLRv4Lexer.CLOSURE) || (LA36_0 >= ANTLRv4Lexer.OPTIONAL && LA36_0 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA36_0 >= ANTLRv4Lexer.SET && LA36_0 <= ANTLRv4Lexer.WILDCARD))) {
                                alt36 = 1;
                            }
                ...
                case 2: {
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:793:4: ^( ALT ( elementOptions )? EPSILON )
                    {
                        ...
                        if ((LA37_0 === ANTLRv4Lexer.ELEMENT_OPTIONS)) {
                            alt37 = 1;
                        }
                        switch (alt37) {
                            case 1: {
        ...
        try {
                ...
                case ANTLRv4Lexer.ACTION: {
                    {
                        ...
                        if ((LA40_4 === Constants.DOWN)) {
                            ...
                            if (((LA40_4 >= Constants.UP && LA40_4 <= ANTLRv4Lexer.ACTION) || LA40_4 === ANTLRv4Lexer.ASSIGN || LA40_4 === ANTLRv4Lexer.DOT || LA40_4 === ANTLRv4Lexer.NOT || LA40_4 === ANTLRv4Lexer.PLUS_ASSIGN || LA40_4 === ANTLRv4Lexer.RANGE || LA40_4 === ANTLRv4Lexer.RULE_REF || LA40_4 === ANTLRv4Lexer.SEMPRED || LA40_4 === ANTLRv4Lexer.STRING_LITERAL || LA40_4 === ANTLRv4Lexer.TOKEN_REF || (LA40_4 >= ANTLRv4Lexer.BLOCK && LA40_4 <= ANTLRv4Lexer.CLOSURE) || (LA40_4 >= ANTLRv4Lexer.OPTIONAL && LA40_4 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA40_4 >= ANTLRv4Lexer.SET && LA40_4 <= ANTLRv4Lexer.WILDCARD))) {
                                alt40 = 4;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
                ...
                case ANTLRv4Lexer.SEMPRED: {
                    {
                        ...
                        if ((LA40_5 === Constants.DOWN)) {
                            ...
                            if (((LA40_5 >= Constants.UP && LA40_5 <= ANTLRv4Lexer.ACTION) || LA40_5 === ANTLRv4Lexer.ASSIGN || LA40_5 === ANTLRv4Lexer.DOT || LA40_5 === ANTLRv4Lexer.NOT || LA40_5 === ANTLRv4Lexer.PLUS_ASSIGN || LA40_5 === ANTLRv4Lexer.RANGE || LA40_5 === ANTLRv4Lexer.RULE_REF || LA40_5 === ANTLRv4Lexer.SEMPRED || LA40_5 === ANTLRv4Lexer.STRING_LITERAL || LA40_5 === ANTLRv4Lexer.TOKEN_REF || (LA40_5 >= ANTLRv4Lexer.BLOCK && LA40_5 <= ANTLRv4Lexer.CLOSURE) || (LA40_5 >= ANTLRv4Lexer.OPTIONAL && LA40_5 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA40_5 >= ANTLRv4Lexer.SET && LA40_5 <= ANTLRv4Lexer.WILDCARD))) {
                                alt40 = 5;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
                ...
                case ANTLRv4Lexer.NOT: {
                    {
                        ...
                        if ((LA40_7 === Constants.DOWN)) {
                            ...
                            if ((LA40_12 === ANTLRv4Lexer.SET)) {
                                alt40 = 9;
                            } else {
                                if ((LA40_12 === ANTLRv4Lexer.BLOCK)) {
                                    alt40 = 10;
                                } else {
                                    const nvaeMark = this.input.mark();
                                    try {
            ...
            switch (alt40) {
                ...
                case 4: {
                    ...
                    {
                        ACTION28 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                ...
                case 5: {
                    ...
                    {
                        SEMPRED29 = this.match(this.input, ANTLRv4Lexer.SEMPRED, null) as GrammarAST;
                ...
                case 6: {
                    ...
                    {
                        ACTION30 = this.match(this.input, ANTLRv4Lexer.ACTION, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 7: {
                    ...
                    {
                        SEMPRED31 = this.match(this.input, ANTLRv4Lexer.SEMPRED, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
    ...
    public astOperand(): GrammarTreeVisitor.astOperand_return {
        ...
        try {
            ...
            if ((LA41_0 === ANTLRv4Lexer.DOT || LA41_0 === ANTLRv4Lexer.RULE_REF || LA41_0 === ANTLRv4Lexer.STRING_LITERAL || LA41_0 === ANTLRv4Lexer.TOKEN_REF || (LA41_0 >= ANTLRv4Lexer.SET && LA41_0 <= ANTLRv4Lexer.WILDCARD))) {
                alt41 = 1;
            } else {
                if ((LA41_0 === ANTLRv4Lexer.NOT)) {
                    const LA41_2 = this.input.LA(2);
                    if ((LA41_2 === Constants.DOWN)) {
                        const LA41_3 = this.input.LA(3);
                        if ((LA41_3 === ANTLRv4Lexer.SET)) {
                            alt41 = 2;
                        } else {
                            if ((LA41_3 === ANTLRv4Lexer.BLOCK)) {
                                alt41 = 3;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
    ...
    public labeledElement(): GrammarTreeVisitor.labeledElement_return {
        ...
        try {
            ...
            {
                if (this.input.LA(1) === ANTLRv4Lexer.ASSIGN || this.input.LA(1) === ANTLRv4Lexer.PLUS_ASSIGN) {
                    this.input.consume();
                    this.state.errorRecovery = false;
                } else {
                    const mse = new MismatchedSetException(null, this.input);
                ...
                this.match(this.input, Constants.DOWN, null);
                ID32 = this.match(this.input, ANTLRv4Lexer.ID, null) as GrammarAST;
    ...
    public subrule(): GrammarTreeVisitor.subrule_return {
        ...
        try {
            ...
            if ((LA42_0 === ANTLRv4Lexer.CLOSURE || (LA42_0 >= ANTLRv4Lexer.OPTIONAL && LA42_0 <= ANTLRv4Lexer.POSITIVE_CLOSURE))) {
                alt42 = 1;
            } else {
                if ((LA42_0 === ANTLRv4Lexer.BLOCK)) {
                    alt42 = 2;
                } else {
                    const nvae =
    ...
    public lexerSubrule(): GrammarTreeVisitor.lexerSubrule_return {
        ...
        try {
            ...
            if ((LA43_0 === ANTLRv4Lexer.CLOSURE || (LA43_0 >= ANTLRv4Lexer.OPTIONAL && LA43_0 <= ANTLRv4Lexer.POSITIVE_CLOSURE))) {
                alt43 = 1;
            } else {
                if ((LA43_0 === ANTLRv4Lexer.BLOCK)) {
                    alt43 = 2;
                } else {
                    const nvae =
        ...
        try {
                ...
                case ANTLRv4Lexer.DOT: {
                    {
                        ...
                        if ((LA44_1 === Constants.DOWN)) {
                            ...
                            if ((LA44_6 === ANTLRv4Lexer.ID)) {
                                const LA44_9 = this.input.LA(4);
                                if ((LA44_9 === ANTLRv4Lexer.STRING_LITERAL || LA44_9 === ANTLRv4Lexer.TOKEN_REF)) {
                                    alt44 = 1;
                                } else {
                                    if ((LA44_9 === ANTLRv4Lexer.RULE_REF)) {
                                        alt44 = 2;
                                    } else {
                                        const nvaeMark = this.input.mark();
                                        try {
                ...
                case ANTLRv4Lexer.WILDCARD: {
                    {
                        ...
                        if ((LA44_2 === Constants.DOWN)) {
                            ...
                            if ((LA44_2 === ANTLRv4Lexer.EOF || (LA44_2 >= Constants.UP && LA44_2 <= ANTLRv4Lexer.ACTION) || LA44_2 === ANTLRv4Lexer.ASSIGN || LA44_2 === ANTLRv4Lexer.DOT || LA44_2 === ANTLRv4Lexer.NOT || LA44_2 === ANTLRv4Lexer.PLUS_ASSIGN || LA44_2 === ANTLRv4Lexer.RANGE || LA44_2 === ANTLRv4Lexer.RULE_REF || LA44_2 === ANTLRv4Lexer.SEMPRED || LA44_2 === ANTLRv4Lexer.STRING_LITERAL || LA44_2 === ANTLRv4Lexer.TOKEN_REF || (LA44_2 >= ANTLRv4Lexer.BLOCK && LA44_2 <= ANTLRv4Lexer.CLOSURE) || (LA44_2 >= ANTLRv4Lexer.OPTIONAL && LA44_2 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA44_2 >= ANTLRv4Lexer.SET && LA44_2 <= ANTLRv4Lexer.WILDCARD))) {
                                alt44 = 4;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
            ...
            switch (alt44) {
                ...
                case 3: {
                    ...
                    {
                        WILDCARD34 = this.match(this.input, ANTLRv4Lexer.WILDCARD, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 4: {
                    ...
                    {
                        WILDCARD35 = this.match(this.input, ANTLRv4Lexer.WILDCARD, null) as GrammarAST;
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:928:4: ^( SET ( setElement )+ )
            {
                ...
                while (true) {
                    ...
                    if ((LA45_0 === ANTLRv4Lexer.LEXER_CHAR_SET || LA45_0 === ANTLRv4Lexer.RANGE || LA45_0 === ANTLRv4Lexer.STRING_LITERAL || LA45_0 === ANTLRv4Lexer.TOKEN_REF)) {
                        alt45 = 1;
                    }
        ...
        try {
                ...
                case ANTLRv4Lexer.STRING_LITERAL: {
                    {
                        ...
                        if ((LA46_1 === Constants.DOWN)) {
                            ...
                            if ((LA46_1 === Constants.UP || LA46_1 === ANTLRv4Lexer.LEXER_CHAR_SET || LA46_1 === ANTLRv4Lexer.RANGE || LA46_1 === ANTLRv4Lexer.STRING_LITERAL || LA46_1 === ANTLRv4Lexer.TOKEN_REF)) {
                                alt46 = 3;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
                ...
                case ANTLRv4Lexer.TOKEN_REF: {
                    {
                        ...
                        if ((LA46_2 === Constants.DOWN)) {
                            ...
                            if ((LA46_2 === Constants.UP || LA46_2 === ANTLRv4Lexer.LEXER_CHAR_SET || LA46_2 === ANTLRv4Lexer.RANGE || LA46_2 === ANTLRv4Lexer.STRING_LITERAL || LA46_2 === ANTLRv4Lexer.TOKEN_REF)) {
                                alt46 = 4;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
            ...
            switch (alt46) {
                case 1: {
                    ...
                    {
                        STRING_LITERAL36 = this.match(this.input, ANTLRv4Lexer.STRING_LITERAL, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 2: {
                    ...
                    {
                        TOKEN_REF37 = this.match(this.input, ANTLRv4Lexer.TOKEN_REF, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 3: {
                    ...
                    {
                        STRING_LITERAL38 = this.match(this.input, ANTLRv4Lexer.STRING_LITERAL, null) as GrammarAST;
                ...
                case 4: {
                    ...
                    {
                        TOKEN_REF39 = this.match(this.input, ANTLRv4Lexer.TOKEN_REF, null) as GrammarAST;
    ...
    public block(): GrammarTreeVisitor.block_return {
        ...
        try {
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:957:7: ^( BLOCK ( optionsSpec )? ( ruleAction )* ( ACTION )? ( alternative )+ )
            {
                ...
                if ((LA47_0 === ANTLRv4Lexer.OPTIONS)) {
                    alt47 = 1;
                }
                switch (alt47) {
                    case 1: {
    ...
    public ruleref(): GrammarTreeVisitor.ruleref_return {
        ...
        try {
            ...
            {
                RULE_REF40 = this.match(this.input, ANTLRv4Lexer.RULE_REF, null) as GrammarAST;
                if (this.input.LA(1) === Constants.DOWN) {
                    this.match(this.input, Constants.DOWN, null);
                    // org/antlr/v4/parse/GrammarTreeVisitor.g:967:21: (arg= ARG_ACTION )?
                    let alt51 = 2;
                    const LA51_0 = this.input.LA(1);
                    if ((LA51_0 === ANTLRv4Lexer.ARG_ACTION)) {
                        alt51 = 1;
                    }
                    switch (alt51) {
                        case 1: {
                            // org/antlr/v4/parse/GrammarTreeVisitor.g:967:21: arg= ARG_ACTION
                            {
                                arg = this.match(this.input, ANTLRv4Lexer.ARG_ACTION, null) as GrammarAST;
                            }
                            break;
                        }
                    ...
                    if ((LA52_0 === ANTLRv4Lexer.ELEMENT_OPTIONS)) {
                        alt52 = 1;
                    }
                    switch (alt52) {
                        case 1: {
    ...
    public terminal(): GrammarTreeVisitor.terminal_return {
        ...
        try {
            ...
            if ((LA53_0 === ANTLRv4Lexer.STRING_LITERAL)) {
                const LA53_1 = this.input.LA(2);
                if ((LA53_1 === Constants.DOWN)) {
                    alt53 = 1;
                } else {
                    if ((LA53_1 === ANTLRv4Lexer.EOF || (LA53_1 >= Constants.UP && LA53_1 <= ANTLRv4Lexer.ACTION) || LA53_1 === ANTLRv4Lexer.ASSIGN || LA53_1 === ANTLRv4Lexer.DOT || LA53_1 === ANTLRv4Lexer.LEXER_CHAR_SET || LA53_1 === ANTLRv4Lexer.NOT || LA53_1 === ANTLRv4Lexer.PLUS_ASSIGN || LA53_1 === ANTLRv4Lexer.RANGE || LA53_1 === ANTLRv4Lexer.RULE_REF || LA53_1 === ANTLRv4Lexer.SEMPRED || LA53_1 === ANTLRv4Lexer.STRING_LITERAL || LA53_1 === ANTLRv4Lexer.TOKEN_REF || (LA53_1 >= ANTLRv4Lexer.BLOCK && LA53_1 <= ANTLRv4Lexer.CLOSURE) || LA53_1 === ANTLRv4Lexer.EPSILON || (LA53_1 >= ANTLRv4Lexer.OPTIONAL && LA53_1 <= ANTLRv4Lexer.POSITIVE_CLOSURE) || (LA53_1 >= ANTLRv4Lexer.SET && LA53_1 <= ANTLRv4Lexer.WILDCARD))) {
                        alt53 = 2;
                    } else {
                        const nvaeMark = this.input.mark();
                        try {
                ...
                if ((LA53_0 === ANTLRv4Lexer.TOKEN_REF)) {
            ...
            switch (alt53) {
                case 1: {
                    ...
                    {
                        STRING_LITERAL41 = this.match(this.input, ANTLRv4Lexer.STRING_LITERAL, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 2: {
                    ...
                    {
                        STRING_LITERAL42 = this.match(this.input, ANTLRv4Lexer.STRING_LITERAL, null) as GrammarAST;
                ...
                case 3: {
                    ...
                    {
                        TOKEN_REF43 = this.match(this.input, ANTLRv4Lexer.TOKEN_REF, null) as GrammarAST;
                        this.match(this.input, Constants.DOWN, null);
                        this.elementOptions();
                ...
                case 4: {
                    ...
                    {
                        TOKEN_REF44 = this.match(this.input, ANTLRv4Lexer.TOKEN_REF, null) as GrammarAST;
            ...
            // org/antlr/v4/parse/GrammarTreeVisitor.g:1005:7: ^( ELEMENT_OPTIONS ( elementOption[(GrammarASTWithOptions)$start.getParent()] )* )
            {
                ...
                if (this.input.LA(1) === Constants.DOWN) {
                    ...
                    while (true) {
                        ...
                        if ((LA54_0 === ANTLRv4Lexer.ASSIGN || LA54_0 === ANTLRv4Lexer.ID)) {
                            alt54 = 1;
                        }
