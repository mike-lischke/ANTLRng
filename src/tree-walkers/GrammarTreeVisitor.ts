                ...
                case GrammarTreeVisitor.STRING_LITERAL: {
                    {
                        ...
                        if ((LA46_1 === Constants.DOWN)) {
                            ...
                            if ((LA46_1 === Constants.UP || LA46_1 === GrammarTreeVisitor.LEXER_CHAR_SET || LA46_1 === GrammarTreeVisitor.RANGE || LA46_1 === GrammarTreeVisitor.STRING_LITERAL || LA46_1 === GrammarTreeVisitor.TOKEN_REF)) {
                                alt46 = 3;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
                ...
                case GrammarTreeVisitor.TOKEN_REF: {
                    {
                        ...
                        if ((LA46_2 === Constants.DOWN)) {
                            ...
                            if ((LA46_2 === Constants.UP || LA46_2 === GrammarTreeVisitor.LEXER_CHAR_SET || LA46_2 === GrammarTreeVisitor.RANGE || LA46_2 === GrammarTreeVisitor.STRING_LITERAL || LA46_2 === GrammarTreeVisitor.TOKEN_REF)) {
                                alt46 = 4;
                            } else {
                                const nvaeMark = this.input.mark();
                                try {
