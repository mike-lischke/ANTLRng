...
export  class Recognizer<Symbol, ATNInterpreter extends ATNSimulator> {
	...
	private static readonly  tokenTypeMapCache?:  Map<Vocabulary, Map<string, java.lang.Integer>> =
		new  WeakHashMap<Vocabulary, Map<string, java.lang.Integer>>();
	private static readonly  ruleIndexMapCache?:  Map<string[], Map<string, java.lang.Integer>> =
		new  WeakHashMap<string[], Map<string, java.lang.Integer>>();
...
public constructor() {
	 ...
	 */
	public getTokenTypeMap = (): Map<string, java.lang.Integer> => {
		let  vocabulary: Vocabulary = this.getVocabulary();
		synchronized (Recognizer.tokenTypeMapCache) {
			let  result: Map<string, java.lang.Integer> = Recognizer.tokenTypeMapCache.get(vocabulary);
			if (result === undefined) {
	 ...
	 * <p>Used for XPath and tree pattern compilation.</p>
	 */
	public getRuleIndexMap = (): Map<string, java.lang.Integer> => {
		...
		synchronized (Recognizer.ruleIndexMapCache) {
			let  result: Map<string, java.lang.Integer> = Recognizer.ruleIndexMapCache.get(ruleNames);
			if (result === undefined) {
