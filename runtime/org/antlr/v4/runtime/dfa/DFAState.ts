...
const stateNumber = stateNumberOrConfigs as number; this.stateNumber = stateNumber; }
 else  {
let configs = stateNumberOrConfigs as ATNConfigSet; this.configs = configs; }
	 ...
	 *  DFA state.
	 */
	public getAltSet = (): Set<java.lang.Integer> => {
		let  alts: Set<java.lang.Integer> = new  HashSet<java.lang.Integer>();
 ...
 return true;
		...
		let  other: DFAState = o as DFAState;
