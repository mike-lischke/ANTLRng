...
export class CommonTokenFactory extends JavaObject implements TokenFactory<CommonToken> {
    ...
    public create(type: number, text: java.lang.String | null): CommonToken;
    public create(source: Pair<TokenSource, CharStream>, type: number, text: java.lang.String | null,
        channel: number, start: number, stop: number, line: number, charPositionInLine: number): CommonToken;
    public create(typeOrSource: number | Pair<TokenSource, CharStream>, textOrType: java.lang.String | number | null,
        text?: java.lang.String | null, channel?: number, start?: number, stop?: number, line?: number,
        charPositionInLine?: number): CommonToken {
        if (typeof typeOrSource === "number") {
            const type = typeOrSource;
            const text = textOrType;

            return new CommonToken(type, text as java.lang.String);
        } else {
            const source = typeOrSource;
            const type = textOrType as number;
