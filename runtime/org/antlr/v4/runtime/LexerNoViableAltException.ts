...
export class LexerNoViableAltException extends RecognitionException {
    ...
    public constructor(lexer: Lexer | null, input: CharStream | null, startIndex: number,
        deadEndConfigs: ATNConfigSet | null) {

        // @ts-ignore, it's beyond me why this is needed, LexerATNSimulator is obviously an ATNSimulator.
        const t = lexer as Recognizer<unknown, ATNSimulator>;
        super(t, input, null);
    ...
    public toString = (): java.lang.String => {
        ...
        return java.lang.String.format(java.util.Locale.getDefault(), S`%s('%s')`,
            LexerNoViableAltException.class.getSimpleName(), symbol);
    };
}
