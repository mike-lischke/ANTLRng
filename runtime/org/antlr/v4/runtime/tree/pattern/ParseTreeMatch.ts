...
export  class ParseTreeMatch extends JavaObject {
	 ...
	 */
	public constructor(tree: ParseTree| null, pattern: ParseTreePattern| null, labels: MultiMap<java.lang.String, ParseTree>| null, mismatchedNode: ParseTree| null) {
		super();
if (tree === null) {
		...
		if (pattern === null) {
			throw new  java.lang.IllegalArgumentException(S`pattern cannot be null`);
		}

		if (labels === null) {
			throw new  java.lang.IllegalArgumentException(S`labels cannot be null`);
		}
	...
	public getLabels = ():  MultiMap<java.lang.String, ParseTree> | null => {
		return this.labels;
	}
