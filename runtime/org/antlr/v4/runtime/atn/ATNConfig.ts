...
const old = oldOrCOrState as ATNConfig; // dup
...
const state = stateOrSemanticContextOrAlt as ATNState;
	...
	{
const c = oldOrCOrState as ATNConfig;
const semanticContext = stateOrSemanticContextOrAlt as SemanticContext;
	...
	{
const state = oldOrCOrState as ATNState;
const alt = stateOrSemanticContextOrAlt as number;
...
const c = oldOrCOrState as ATNConfig;
const state = stateOrSemanticContextOrAlt as ATNState;
const semanticContext = contextOrSemanticContext as SemanticContext;
...
const context = contextOrSemanticContext as PredictionContext;
    ...
    {
let c = oldOrCOrState as ATNConfig;
let state = stateOrSemanticContextOrAlt as ATNState;
let context = contextOrSemanticContext as PredictionContext;
		this.state = state;
		this.alt = c.alt;
		this.context = context;
		this.semanticContext = semanticContext;
...
const o = oOrOther as object;
		...
		return this.equals(o as ATNConfig);
	}
 else  {
let other = oOrOther as ATNConfig;
		if (this === other) {
			return true;
		}
