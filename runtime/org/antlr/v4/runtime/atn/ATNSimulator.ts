...
export abstract class ATNSimulator {
     ...
     */
    protected readonly sharedContextCache?: PredictionContextCache;
    ...
    public getCachedContext = (context: PredictionContext): PredictionContext => {
        if (this.sharedContextCache === undefined) {
            return context;
        }

		/* synchronized (sharedContextCache) */ {
            const visited: IdentityHashMap<PredictionContext, PredictionContext> =
