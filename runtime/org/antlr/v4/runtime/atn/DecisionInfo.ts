 ...
 *
 */
export class DecisionInfo extends JavaObject {
    /**
     ...
     * SLL conflict state, or encountering a syntax error.
     */
    public SLL_MaxLook = 0n;

    /**
     * Gets the {@link LookaheadEventInfo} associated with the event where the
     * {@link #SLL_MaxLook} value was set.
     */
    public SLL_MaxLookEvent: LookaheadEventInfo | null = null;
     ...
     * {@link PredictionMode#LL_EXACT_AMBIG_DETECTION}, or a syntax error.
     */
    public LL_MaxLook = 0n;

    /**
     * Gets the {@link LookaheadEventInfo} associated with the event where the
     * {@link #LL_MaxLook} value was set.
     */
    public LL_MaxLookEvent: LookaheadEventInfo | null = null;
     ...
     */
    public readonly contextSensitivities = new java.util.ArrayList<ContextSensitivityInfo>();
     ...
     * @see ErrorInfo
     */
    public readonly errors = new java.util.ArrayList<ErrorInfo>();
     ...
     * @see AmbiguityInfo
     */
    public readonly ambiguities = new java.util.ArrayList<AmbiguityInfo>();
     ...
     */
    public readonly predicateEvals = new java.util.ArrayList<PredicateEvalInfo>();
