...
export  class DecisionInfo extends JavaObject {
	 ...
	 */
	public SLL_MaxLookEvent:  LookaheadEventInfo | null;
	 ...
	 */
	public LL_MaxLookEvent:  LookaheadEventInfo | null;
	 ...
	 */
	public readonly  contextSensitivities:  java.util.List<ContextSensitivityInfo> | null = new  java.util.ArrayList<ContextSensitivityInfo>();
	 ...
	 * @see ErrorInfo
	 */
	public readonly  errors:  java.util.List<ErrorInfo> | null = new  java.util.ArrayList<ErrorInfo>();
	 ...
	 * @see AmbiguityInfo
	 */
	public readonly  ambiguities:  java.util.List<AmbiguityInfo> | null = new  java.util.ArrayList<AmbiguityInfo>();
	 ...
	 */
	public readonly  predicateEvals:  java.util.List<PredicateEvalInfo> | null = new  java.util.ArrayList<PredicateEvalInfo>();
