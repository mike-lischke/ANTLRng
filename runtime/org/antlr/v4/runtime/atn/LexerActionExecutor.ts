...
export class LexerActionExecutor {
    ...
    public static append = (lexerActionExecutor: LexerActionExecutor, lexerAction: LexerAction): LexerActionExecutor => {
        ...
        const lexerActions: LexerAction[] = java.util.Arrays.copyOf(lexerActionExecutor.lexerActions, lexerActionExecutor.lexerActions.length + 1);
    ...
    public fixOffsetBeforeMatch = (offset: number): LexerActionExecutor => {
        let updatedLexerActions: LexerAction[];
        ...
        try {
            for (let lexerAction of this.lexerActions) {
                if (lexerAction instanceof LexerIndexedCustomAction) {
                    const offset: number = (lexerAction).getOffset();
