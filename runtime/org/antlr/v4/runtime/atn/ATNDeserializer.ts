...
export  class ATNDeserializer extends JavaObject {
	...
	private readonly  deserializationOptions:  ATNDeserializationOptions | null;

	/* eslint-disable constructor-super, @typescript-eslint/no-unsafe-call */
public constructor();

	public constructor(deserializationOptions: ATNDeserializationOptions| null);
/* @ts-expect-error, because of the super() call in the closure. */
public constructor(deserializationOptions?: ATNDeserializationOptions | null) {
const $this = (deserializationOptions?: ATNDeserializationOptions | null): void => {
...
/* eslint-enable constructor-super, @typescript-eslint/no-unsafe-call */
	...
	public deserialize(data: Uint16Array):  ATN | null;

	public deserialize(data: Int32Array):  ATN | null;


	public deserialize(data: Uint16Array | Int32Array):  ATN | null {
if (data instanceof Uint16Array) {
		...
		if (version !== ATNDeserializer.SERIALIZED_VERSION) {
			let  reason: java.lang.String = java.lang.String.format(java.util.Locale.getDefault(), "Could not deserialize ATN with version %d (expected %d).", version, ATNDeserializer.SERIALIZED_VERSION);
	...
	protected verifyATN = (atn: ATN| null):  void => {
		...
		for (let state of atn.states) {
			...
			if (state instanceof PlusBlockStartState) {
				this.checkCondition((state as PlusBlockStartState).loopBackState !== null);
			}
			...
			if (state instanceof LoopEndState) {
				this.checkCondition((state as LoopEndState).loopBackState !== null);
			}

			if (state instanceof RuleStartState) {
				this.checkCondition((state as RuleStartState).stopState !== null);
			}

			if (state instanceof BlockStartState) {
				this.checkCondition((state as BlockStartState).endState !== null);
			}

			if (state instanceof BlockEndState) {
				this.checkCondition((state as BlockEndState).startState !== null);
			}
...
if (data instanceof Uint16Array) {
	...
	protected edgeFactory = (atn: ATN| null,
										 type: number, src: number, trg: number,
										 arg1: number, arg2: number, arg3: number,
										 sets: java.util.List<IntervalSet>| null):  Transition | null =>
	{
...
default:
	...
	protected stateFactory = (type: number, ruleIndex: number):  ATNState | null => {
		...
		switch (type) {
			...
			default :{
				let  message: java.lang.String = java.lang.String.format(java.util.Locale.getDefault(), "The specified state type %d is not valid.", type);
	...
	protected lexerActionFactory = (type: LexerActionType| null, data1: number, data2: number):  LexerAction | null => {
		switch (type) {
		...
		default:{
			throw new  java.lang.IllegalArgumentException(java.lang.String.format(java.util.Locale.getDefault(), "The specified lexer action type %s is not valid.", type));
}
	 ...
	 */
	public static encodeIntsWith16BitWords = (data: IntegerList| null):  IntegerList | null => {
