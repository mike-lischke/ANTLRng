...
export  class ATNConfigSet extends JavaObject implements java.util.Set<ATNConfig> {
	...
	public static readonly  ConfigEqualityComparator =  class ConfigEqualityComparator extends AbstractEqualityComparator<ATNConfig> {
		public static readonly  INSTANCE:  ConfigEqualityComparator | null = new  ConfigEqualityComparator();

		private constructor() {
		}

		public hashCode = (o: ATNConfig| null):  number => {
 ...
 return false;
	...
	public readonly  configs:  java.util.ArrayList<ATNConfig> | null = new  java.util.ArrayList<ATNConfig>(7);
	 ...
	 *  that have predicates that evaluate to false. Computed in computeTargetState().
 	 */
	protected conflictingAlts:  java.util.BitSet | null;
	...
	public constructor();public constructor(fullCtx: boolean);

	public constructor(old: ATNConfigSet| null);
/* @ts-expect-error, because of the super() call in the closure. */
public constructor(fullCtxOrOld?: boolean | ATNConfigSet | null) {
const $this = (fullCtxOrOld?: boolean | ATNConfigSet | null): void => {
...
/* eslint-enable constructor-super, @typescript-eslint/no-unsafe-call */
	...
	public add(config: ATNConfig| null):  boolean;
	 ...
	 */
	public add(
		config: ATNConfig| null,
		mergeCache: DoubleKeyMap<PredictionContext,PredictionContext,PredictionContext>| null):  boolean;


	public add(config: ATNConfig | null, mergeCache?: DoubleKeyMap<PredictionContext,PredictionContext,PredictionContext> | null):  boolean {
if (mergeCache === undefined) {
 ...
 throw new  java.lang.IllegalStateException("This set is readonly");
    ...
    public elements = ():  java.util.List<ATNConfig> | null => { return this.configs; }

	public getStates = ():  java.util.Set<ATNState> | null => {
		let  states: java.util.Set<ATNState> = new  java.util.HashSet<ATNState>();
	...
	public getAlts = ():  java.util.BitSet | null => {
		let  alts: java.util.BitSet = new  java.util.BitSet();
	...
	public get = (i: number):  ATNConfig | null => { return this.configs.get(i); }

	public optimizeConfigs = (interpreter: ATNSimulator| null):  void => {
		if ( this.readonly ) {
 throw new  java.lang.IllegalStateException("This set is readonly");
}
...
//			System.out.println("configs "+before+"->"+after);
	...
	public addAll = (coll: java.util.Collection< ATNConfig>| null):  boolean => {
...
//		System.out.print("equals " + this + ", " + o+" = ");
		...
		let  same: boolean = this.configs!==null &&
...
//		System.out.println(same);
	...
	public containsFast = (obj: ATNConfig| null):  boolean => {
		if (this.configLookup === null) {
			throw new  java.lang.UnsupportedOperationException("This method is not implemented for readonly sets.");
		}
	...
	public iterator = ():  Iterator<ATNConfig> | null => {
 ...
 buf.append(",dipsIntoOuterContext");
	...
	public toArray():  ATNConfig[] | null;

	public toArray <T>(a: T[]| null):  T[] | null;


	// satisfy interface

	public toArray(a?: T[] | null):  ATNConfig[] | null |  T[] | null {
if (a === undefined) {
	...
	public containsAll = (c: java.util.Collection<unknown>| null):  boolean => {
		throw new  java.lang.UnsupportedOperationException();
	}
	...
	public static abstract AbstractConfigHashSet =  class AbstractConfigHashSet extends Array2DHashSet<ATNConfig> {
		...
		public constructor(comparator: AbstractEqualityComparator< ATNConfig>| null);

		public constructor(comparator: AbstractEqualityComparator< ATNConfig>| null, initialCapacity: number, initialBucketCapacity: number);
public constructor(comparator: AbstractEqualityComparator< ATNConfig> | null, initialCapacity?: number, initialBucketCapacity?: number) {
const $this = (comparator: AbstractEqualityComparator< ATNConfig> | null, initialCapacity?: number, initialBucketCapacity?: number): void => {
...
$this(comparator, initialCapacity, initialBucketCapacity);
		...
		protected readonly  asElementType = (o: java.lang.Object| null):  ATNConfig | null => {
		...
		protected readonly  createBuckets = (capacity: number):  ATNConfig[][] | null => {
			return new   Array<ATNConfig>(capacity)[];
		}

		protected readonly  createBucket = (capacity: number):  ATNConfig[] | null => {
			return new   Array<ATNConfig>(capacity);
		}
