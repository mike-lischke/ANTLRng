...
export  class ATNSerializer extends JavaObject {
	...
	private readonly  data:  IntegerList | null = new  IntegerList();
	/** Note that we use a LinkedHashMap as a set to mainintain insertion order while deduplicating
	    entries with the same key. */
	private readonly  sets:  java.util.Map<IntervalSet, java.lang.Boolean> | null = new  java.util.LinkedHashMap();
	...
	public constructor(atn: ATN| null) {
		super();
/* assert atn.grammarType != null; */ 
	...
	public serialize = ():  IntegerList | null => {
		...
		let  setIndices: java.util.Map<IntervalSet, java.lang.Integer> = null;
