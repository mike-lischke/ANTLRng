...
type Config = import("jest").Config;
...
// Cannot use `export default config;` because there's a change in TS 5.6 which inserts another `export {}` line
// which fails to transpile to JS.
