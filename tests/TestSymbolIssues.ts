...
export  class TestSymbolIssues {
    ...
    @Test
public  testA():  void { testErrors(TestSymbolIssues.A, false); }
    @Test
public  testB():  void { testErrors(TestSymbolIssues.B, false); }
	@Test
public  testD():  void { testErrors(TestSymbolIssues.D, false); }
	@Test
public  testE():  void { testErrors(TestSymbolIssues.E, false); }
	@Test
public  testF():  void { testErrors(TestSymbolIssues.F, false); }

	@Test
public  testStringLiteralRedefs():  void {
		let  grammar =
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"mode X;\n"+
		...
		let  g = new  LexerGrammar(grammar);

		let  expectedTokenIDToTypeMap = "{EOF=-1, A=1, B=2, C=3}";
		let  expectedStringLiteralToTypeMap = "{}";
		let  expectedTypeToTokenList = "[A, B, C]";
	...
	@Test
public  testEmptyLexerModeDetection():  void {
		let  test = [
			"lexer grammar L;\n" +
			"A : 'a';\n" +
			"mode X;\n" +
	...
	@Test
public  testEmptyLexerRuleDetection():  void {
		let  test = [
			"lexer grammar L;\n" +
			"A : 'a';\n" +
			"WS : [ \t]* -> skip;\n" +
	...
	@Test
public  testTokensModesChannelsDeclarationConflictsWithReserved():  void {
		let  test = [
			"lexer grammar L;\n" +
	...
	@Test
public  testTokensModesChannelsUsingConflictsWithReserved():  void {
		let  test = [
			"lexer grammar L;\n" +
			"A: 'a' -> channel(SKIP);\n" +
			"B: 'b' -> type(MORE);\n" +
	...
	@Test
public  testWrongIdForTypeChannelModeCommand():  void {
		let  test = [
			"lexer grammar L;\n" +
			"tokens { TOKEN1 }\n" +
			"channels { CHANNEL1 }\n" +
	...
	@Test
public  testDuplicatedCommands():  void {
		let  test = [
			"lexer grammar Lexer;\n" +
	...
	// https://github.com/antlr/antlr4/issues/1388
	@Test
public  testIncompatibleCommands():  void {
		let  test = [
				"lexer grammar L;\n" +
				"channels { CHANNEL1 }\n" +
				"tokens { TYPE1 }\n" +
	...
	@Test
public  testLabelsForTokensWithMixedTypes():  void {
		let  test = [
				"grammar L;\n" +
				"\n" +
	...
	@Test
public  testLabelsForTokensWithMixedTypesLRWithLabels():  void {
		let  test = [
				"grammar L;\n" +
				"\n" +
				"expr\n" +
	...
	// https://github.com/antlr/antlr4/issues/1543
	@Test
public  testLabelsForTokensWithMixedTypesLRWithoutLabels():  void {
		let  test = [
				"grammar L;\n" +
				"\n" +
				"expr\n" +
	...
	@Test
public  testCharsCollision():  void {
		let  test = [
				"lexer grammar L;\n" +
				"TOKEN_RANGE:      [aa-f];\n" +
	...
	@Test
public  testCaseInsensitiveCharsCollision():  void {
		let  test = [
				"lexer grammar L;\n" +
	...
	@Test
public  testCaseInsensitiveWithUnicodeRanges():  void {
		let  test = [
				"lexer grammar L;\n" +
				"options { caseInsensitive=true; }\n" +
				"FullWidthLetter\n" +
	...
	@Test
public  testUnreachableTokens():  void {
		let  test = [
				"lexer grammar Test;\n" +
				"TOKEN1: 'as' 'df' | 'qwer';\n" +
				"TOKEN2: [0-9];\n" +
	...
	@Test
public  testIllegalCaseInsensitiveOptionValue():  void {
		let  test = [
				"lexer grammar L;\n" +
	...
	@Test
public  testRedundantCaseInsensitiveLexerRuleOption():  void {
		let  test = [
				"lexer grammar L;\n" +
				"options { caseInsensitive = true; }\n" +
	...
	@Test
public  testCaseInsensitiveOptionInParseRule():  void {
		let  test = [
				"grammar G;\n" +
	...
	@Test
public  testNotImpliedCharacters():  void {
		let  test = [
				"lexer grammar Test;\n" +
				"TOKEN1: 'A'..'g';\n" +
				"TOKEN2: [C-m];\n" +
	...
	@Test
public  testNotImpliedCharactersWithCaseInsensitiveOption():  void {
		let  test = [
				"lexer grammar Test;\n" +
				"options { caseInsensitive=true; }\n" +
				"TOKEN: [A-z];",
	...
	@Test
public  testUndefinedLabel():  void {
		let  test = [
				"grammar Test;" +
				"root\n" +
				"    : root a\n" +
