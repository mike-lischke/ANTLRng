...
export  class TestBasicSemanticErrors {
    protected static readonly  U = [
        // INPUT
        "parser grammar U;\n" +
        "options { foo=bar; k=3;}\n" +
        "tokens {\n" +
	...
	@Test
public  testU():  void { testErrors(TestBasicSemanticErrors.U, false); }
	 ...
	 */
	@Test
public  testIllegalNonSetLabel():  void {
		let  grammar =
			"grammar T;\n" +
			"ss : op=('=' | '+=' | expr) EOF;\n" +
			"expr : '=' '=';\n" +
	...
	@Test
public  testArgumentRetvalLocalConflicts():  void {
		let  grammarTemplate =
			"grammar T;\n" +
