...
export  class TestTokenPositionOptions {
	@Test
public  testLeftRecursionRewrite():  void {
		let  g = new  Grammar(
				"grammar T;\n" +
				"s : e ';' ;\n" +
				"e : e '*' e\n" +
		...
		let  nodes = g.ast.getNodesWithTypePreorderDFS(types);
	...
	@Test
public  testLeftRecursionWithLabels():  void {
		let  g = new  Grammar(
				"grammar T;\n" +
				"s : e ';' ;\n" +
				"e : e '*' x=e\n" +
	...
	@Test
public  testLeftRecursionWithSet():  void {
		let  g = new  Grammar(
				"grammar T;\n" +
				"s : e ';' ;\n" +
				"e : e op=('*'|'/') e\n" +
