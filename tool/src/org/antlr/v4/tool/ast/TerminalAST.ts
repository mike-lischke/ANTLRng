...
export  class TerminalAST extends GrammarASTWithOptions implements RuleElementAST {
    ...
    public constructor(...args: unknown[]) {
		switch (args.length) {
			case 1: {
				const [node] = args as [TerminalAST];
 ...
 super(type, t); 
	...
	@Override
public override  dupNode():  TerminalAST { return new  TerminalAST(this); }
