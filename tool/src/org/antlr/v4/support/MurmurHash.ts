...
/**
 * Type guard to check if a value supports the IComparable interface.
 *
...
export const isComparable = (candidate: unknown): candidate is IComparable => {
    const comparable = candidate as IComparable;

    // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
    return comparable.equals !== undefined && comparable.hashCode !== undefined;
};
