...
public  ctorAttrs:  Collection<AttributeDecl>;
	@ModelElement
public  dispatchMethods:  Array< DispatchMethod>;
	@ModelElement
public  interfaces:  Array<OutputModelObject>;
	@ModelElement
public  extensionMembers:  Array<OutputModelObject>;
...
public addDecl(...args: unknown[]):  void {
		...
		if ( d instanceof ContextGetterDecl ) {
			this.getters.add(d);
			this.signatures.add(( d as ContextGetterDecl).getSignatureDecl());
		} else {
			this.attrs.add(d);
		}
