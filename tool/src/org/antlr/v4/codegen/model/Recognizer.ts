...
export abstract  class Recognizer extends OutputModelObject {
	 ...
	 */
	@Deprecated
public  tokenNames:  Array<string>;
...
public  sempredFuncs =
	...
	public  constructor(factory: OutputModelFactory) {
		...
		for (let entry of g.tokenNameToTypeMap.entrySet()) {
			let  ttype = entry.getValue();
			if ( ttype>0 ) {
	...
	protected static  translateTokenStringsToTarget(tokenStrings: string[], gen: CodeGenerator):  Array<string> {
