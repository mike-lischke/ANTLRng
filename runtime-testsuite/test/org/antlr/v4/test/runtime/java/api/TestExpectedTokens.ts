...
export class TestExpectedTokens extends JavaRunner {
    ...
    public testEpsilonAltSubrule(): void {
        ...
        org.junit.jupiter.api.Assert.assertEquals("{B, C}", tokens.toString(g.getTokenNames()));
    }
    ...
    public testFollowIncluded(): void {
        ...
        org.junit.jupiter.api.Assert.assertEquals("{<EOF>, B}", tokens.toString(g.getTokenNames()));

        // Now call from 'a'
        tokens = atn.getExpectedTokens(blkStartStateNumber, new ParserRuleContext(ParserRuleContext.EMPTY, 4));
        org.junit.jupiter.api.Assert.assertEquals("{A, B}", tokens.toString(g.getTokenNames()));
    }
    ...
    public testFollowIncludedInLeftRecursiveRule(): void {
        ...
        org.junit.jupiter.api.Assert.assertEquals("{R, PLUS}", tokens.toString(g.getTokenNames()));
