...
export class RuntimeTestDescriptorParser extends JavaObject {
    ...
    public static parse(name: String, text: String, uri: URI): RuntimeTestDescriptor {
        ...
        const pairs = new java.util.ArrayList();
        ...
        let grammar = "";
        let grammarName = "";
        const slaveGrammars = new java.util.ArrayList();
        let startRule = "";
        let input = "";
        let output = "";
        let errors = "";
        ...
        for (const p of pairs) {
            ...
            switch (section) {
                ...
                case "slaveGrammar": {
                    const gname = RuntimeTestDescriptorParser.getGrammarName(value.split("\n")[0]);
    ...
    private static getGrammarName(grammarDeclLine: String): String {
        ...
        gi += "grammar ".length();
        const gsemi = grammarDeclLine.indexOf(";");
