...
describe("TestInterpreterDataReader", () => {
    it("testLexerFile", () => {
        const content = readFileSync("runtime-testsuite/generated/VisitorCalcLexer.interp", "utf-8");
    ...
    it("testParserFile", () => {
        const content = readFileSync("runtime-testsuite/generated/VisitorCalc.interp", "utf-8");
        const interpreterData = InterpreterDataReader.parseInterpreterData(content);
